<template>
  <div class="demo">
    <schedule-calendar :events="events" :dateItemRender="itemRender" @event-dragend="changeDate"></schedule-calendar>
  </div>
</template>
<script>
  import ScheduleCalendar from "vue-schedule-calendar/dist/scheduleCalendar"
  export default {
    data(){
      return {
        events: [
